import { Departement, InvalidDepartementError } from '@/archives/departements/Departement.js';
import { describe, expect, it } from 'vitest';

describe('Departement', () => {
    describe('of', () => {
        it('should allow from 01 to 95', () => {
            expect(Departement.of('01').value()).toEqual('01');
            expect(Departement.of('1').value()).toEqual('01');
            expect(Departement.of(1).value()).toEqual('01');
