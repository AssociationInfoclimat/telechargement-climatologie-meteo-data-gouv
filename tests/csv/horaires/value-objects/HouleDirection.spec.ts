...
describe('HouleDirection', () => {
    describe('of', () => {
        it('should accept between 0 and 359, 999, and null', () => {
            expect(HouleDirection.of(PositiveInteger.of(0)).value()).toEqual(0);
            expect(HouleDirection.of(PositiveInteger.of(359)).value()).toEqual(359);
        ...
        it('should not accept other values', () => {
            ...
            expect(() => HouleDirection.of(PositiveInteger.of(360))).toThrow(InvalidHouleDirectionError);
        });
    });
    ...
    describe('toString', () => {
        it('should return the code as a string', () => {
            ...
            expect(HouleDirection.of(PositiveInteger.of(359)).toString()).toEqual('359');
