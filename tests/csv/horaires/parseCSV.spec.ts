            ...
            expect(horaireLines.ok).toEqual<HoraireLine[]>([
                {
                    ...
                    QRR1: CodeQualite.of(Integer.of(1)),
                    DRR1: PositiveInteger.of(null),
                    QDRR1: CodeQualite.of(Integer.of(null)),
                    FF: PositiveFloat.of(2.6),
                    QFF: CodeQualite.of(Integer.of(1)),
                    DD: WindDirection.of(PositiveInteger.of(200)),
                    QDD: CodeQualite.of(Integer.of(1)),
                    ...
                    QFF2: CodeQualite.of(Integer.of(null)),
                    DD2: WindDirection.of(PositiveInteger.of(null)),
                    QDD2: CodeQualite.of(Integer.of(null)),
                    ...
                    HFXI3S: Time.of('2317'),
                    QHFXI3S: CodeQualite.of(Integer.of(9)),
                    T: 12.3,
                    QT: CodeQualite.of(Integer.of(1)),
                    TD: 7.6,
                    QTD: CodeQualite.of(Integer.of(1)),
                    TN: 11.9,
                    ...
                    T10: null,
                    QT10: CodeQualite.of(Integer.of(null)),
                    T20: null,
                    QT20: CodeQualite.of(Integer.of(null)),
                    T50: null,
                    QT50: CodeQualite.of(Integer.of(null)),
                    T100: null,
                    QT100: CodeQualite.of(Integer.of(null)),
                    TNSOL: null,
                    QTNSOL: CodeQualite.of(Integer.of(null)),
                    TN50: null,
                    QTN50: CodeQualite.of(Integer.of(null)),
                    TCHAUSSEE: null,
                    QTCHAUSSEE: CodeQualite.of(Integer.of(null)),
                    DHUMEC: PositiveInteger.of(null),
                    QDHUMEC: CodeQualite.of(Integer.of(null)),
                    U: HumiditeRelative.of(73),
                    QU: CodeQualite.of(Integer.of(1)),
                    UN: HumiditeRelative.of(71),
                    ...
                    QTSV: CodeQualite.of(Integer.of(1)),
                    PMER: PositiveFloat.of(null),
                    QPMER: CodeQualite.of(Integer.of(null)),
                    PSTAT: PositiveFloat.of(null),
                    QPSTAT: CodeQualite.of(Integer.of(null)),
                    PMERMIN: PositiveFloat.of(null),
                    QPMERMIN: CodeQualite.of(Integer.of(null)),
                    GEOP: PositiveInteger.of(null),
                    QGEOP: CodeQualite.of(Integer.of(null)),
                    N: Octa.of(PositiveInteger.of(null)),
                    QN: CodeQualite.of(Integer.of(null)),
                    NBAS: Octa.of(PositiveInteger.of(null)),
                    QNBAS: CodeQualite.of(Integer.of(null)),
                    CL: CodeSynop.of(''),
                    QCL: CodeQualite.of(Integer.of(null)),
                    CM: CodeSynop.of(''),
                    QCM: CodeQualite.of(Integer.of(null)),
                    CH: CodeSynop.of(''),
                    QCH: CodeQualite.of(Integer.of(null)),
                    N1: Octa.of(PositiveInteger.of(null)),
                    QN1: CodeQualite.of(Integer.of(null)),
                    C1: CodeSynop.of(''),
                    QC1: CodeQualite.of(Integer.of(null)),
                    B1: PositiveInteger.of(null),
                    QB1: CodeQualite.of(Integer.of(null)),
                    N2: Octa.of(PositiveInteger.of(null)),
                    QN2: CodeQualite.of(Integer.of(null)),
                    C2: CodeSynop.of(''),
                    QC2: CodeQualite.of(Integer.of(null)),
                    B2: PositiveInteger.of(null),
                    QCB2: CodeQualite.of(Integer.of(null)),
                    N3: Octa.of(PositiveInteger.of(null)),
                    QN3: CodeQualite.of(Integer.of(null)),
                    C3: CodeSynop.of(''),
                    QC3: CodeQualite.of(Integer.of(null)),
                    B3: PositiveInteger.of(null),
                    QB3: CodeQualite.of(Integer.of(null)),
                    N4: Octa.of(PositiveInteger.of(null)),
                    QN4: CodeQualite.of(Integer.of(null)),
                    C4: CodeSynop.of(''),
                    QC4: CodeQualite.of(Integer.of(null)),
                    B4: PositiveInteger.of(null),
                    QB4: CodeQualite.of(Integer.of(null)),
                    VV: PositiveInteger.of(null),
                    QVV: CodeQualite.of(Integer.of(null)),
                    DVV200: PositiveInteger.of(null),
                    QDVV200: CodeQualite.of(Integer.of(null)),
                    WW: CodeTemps.of(''),
                    QWW: CodeQualite.of(Integer.of(null)),
                    W1: CodeTemps.of(''),
                    QW1: CodeQualite.of(Integer.of(null)),
                    W2: CodeTemps.of(''),
                    QW2: CodeQualite.of(Integer.of(null)),
                    SOL: Etat.of(PositiveInteger.of(null)),
                    QSOL: CodeQualite.of(Integer.of(null)),
                    SOLNG: Etat.of(PositiveInteger.of(null)),
                    QSOLNG: CodeQualite.of(Integer.of(null)),
                    TMER: null,
                    QTMER: CodeQualite.of(Integer.of(null)),
                    VVMER: Visibility.of(PositiveInteger.of(null)),
                    QVVMER: CodeQualite.of(Integer.of(null)),
                    ETATMER: Etat.of(PositiveInteger.of(null)),
                    QETATMER: CodeQualite.of(Integer.of(null)),
                    DIRHOULE: HouleDirection.of(PositiveInteger.of(null)),
                    QDIRHOULE: CodeQualite.of(Integer.of(null)),
                    HVAGUE: PositiveFloat.of(null),
                    QHVAGUE: CodeQualite.of(Integer.of(null)),
                    PVAGUE: PositiveFloat.of(null),
                    QPVAGUE: CodeQualite.of(Integer.of(null)),
                    HNEIGEF: PositiveInteger.of(null),
                    QHNEIGEF: CodeQualite.of(Integer.of(null)),
                    NEIGETOT: PositiveInteger.of(0),
                    QNEIGETOT: CodeQualite.of(Integer.of(9)),
                    TSNEIGE: PositiveFloat.of(null),
                    QTSNEIGE: CodeQualite.of(Integer.of(null)),
                    TUBENEIGE: PositiveInteger.of(null),
                    QTUBENEIGE: CodeQualite.of(Integer.of(null)),
                    HNEIGEFI3: PositiveInteger.of(null),
                    QHNEIGEFI3: CodeQualite.of(Integer.of(null)),
                    HNEIGEFI1: PositiveInteger.of(null),
                    QHNEIGEFI1: CodeQualite.of(Integer.of(null)),
                    ESNEIGE: Etat.of(PositiveInteger.of(null)),
                    QESNEIGE: CodeQualite.of(Integer.of(null)),
                    CHARGENEIGE: PositiveInteger.of(null),
                    QCHARGENEIGE: CodeQualite.of(Integer.of(null)),
                    GLO: PositiveInteger.of(null),
                    QGLO: CodeQualite.of(Integer.of(null)),
                    GLO2: PositiveInteger.of(null),
                    QGLO2: CodeQualite.of(Integer.of(null)),
                    DIR: PositiveInteger.of(null),
                    QDIR: CodeQualite.of(Integer.of(null)),
                    DIR2: PositiveInteger.of(null),
                    QDIR2: CodeQualite.of(Integer.of(null)),
                    DIF: PositiveInteger.of(null),
                    QDIF: CodeQualite.of(Integer.of(null)),
                    DIF2: PositiveInteger.of(null),
                    QDIF2: CodeQualite.of(Integer.of(null)),
                    UV: PositiveFloat.of(null),
                    QUV: CodeQualite.of(Integer.of(null)),
                    UV2: PositiveFloat.of(null),
                    QUV2: CodeQualite.of(Integer.of(null)),
                    UV_INDICE: UVIndex.of(PositiveInteger.of(null)),
                    QUV_INDICE: CodeQualite.of(Integer.of(null)),
                    INFRAR: PositiveInteger.of(null),
                    QINFRAR: CodeQualite.of(Integer.of(null)),
                    INFRAR2: PositiveInteger.of(null),
                    QINFRAR2: CodeQualite.of(Integer.of(null)),
                    INS: PositiveInteger.of(null),
                    QINS: CodeQualite.of(Integer.of(null)),
                    INS2: PositiveInteger.of(null),
                    QINS2: CodeQualite.of(Integer.of(null)),
                    TLAGON: null,
                    QTLAGON: CodeQualite.of(Integer.of(null)),
                    TVEGETAUX: null,
                    QTVEGETAUX: CodeQualite.of(Integer.of(null)),
                    ECOULEMENT: null,
                    QECOULEMENT: CodeQualite.of(Integer.of(null)),
                },
                {
                    NUM_POSTE: NumeroPoste.of('01014002'),
                    NOM_USUEL: 'ARBENT',
                    ...
                    DHUMEC: PositiveInteger.of(null),
                    QDHUMEC: CodeQualite.of(Integer.of(null)),
                    U: HumiditeRelative.of(74),
                    QU: CodeQualite.of(Integer.of(1)),
                    UN: HumiditeRelative.of(73),
                    QUN: CodeQualite.of(Integer.of(1)),
                    HUN: Time.of('0001'),
                    QHUN: CodeQualite.of(Integer.of(9)),
                    UX: HumiditeRelative.of(75),
                ...
                },
                {
                    ...
                    QRR1: CodeQualite.of(Integer.of(null)),
                    DRR1: PositiveInteger.of(null),
                    QDRR1: CodeQualite.of(Integer.of(null)),
                    FF: PositiveFloat.of(null),
                    QFF: CodeQualite.of(Integer.of(null)),
                    DD: WindDirection.of(PositiveInteger.of(null)),
                    QDD: CodeQualite.of(Integer.of(null)),
                    ...
                    QDXI3S: CodeQualite.of(Integer.of(null)),
                    HFXI3S: Time.of(''),
                    QHFXI3S: CodeQualite.of(Integer.of(null)),
                    T: null,
                    QT: CodeQualite.of(Integer.of(null)),
                    TD: null,
                    QTD: CodeQualite.of(Integer.of(null)),
                    TN: null,
                    ...
                    QU: CodeQualite.of(Integer.of(null)),
                    ...
                    QTSV: CodeQualite.of(Integer.of(null)),
                    PMER: PositiveFloat.of(null),
                    QPMER: CodeQualite.of(Integer.of(null)),
                    PSTAT: PositiveFloat.of(null),
                    QPSTAT: CodeQualite.of(Integer.of(null)),
                    ...
                    QNEIGETOT: CodeQualite.of(Integer.of(null)),
                    TSNEIGE: PositiveFloat.of(null),
                    QTSNEIGE: CodeQualite.of(Integer.of(null)),
                    TUBENEIGE: PositiveInteger.of(null),
                    QTUBENEIGE: CodeQualite.of(Integer.of(null)),
                ...
                },
                {
                    ...
                    QRR1: CodeQualite.of(Integer.of(0)),
                    DRR1: PositiveInteger.of(4),
                    QDRR1: CodeQualite.of(Integer.of(1)),
                    FF: PositiveFloat.of(3.3),
                    QFF: CodeQualite.of(Integer.of(2)),
                    DD: WindDirection.of(PositiveInteger.of(360)),
                    QDD: CodeQualite.of(Integer.of(9)),
                    FXY: PositiveFloat.of(3.3),
                    QFXY: CodeQualite.of(Integer.of(0)),
                    DXY: WindDirection.of(PositiveInteger.of(360)),
                    QDXY: CodeQualite.of(Integer.of(1)),
                    HXY: Time.of('1230'),
                    QHXY: CodeQualite.of(Integer.of(2)),
                    FXI: PositiveFloat.of(3.3),
                    QFXI: CodeQualite.of(Integer.of(9)),
                    DXI: WindDirection.of(PositiveInteger.of(360)),
                    QDXI: CodeQualite.of(Integer.of(0)),
                    HXI: Time.of('1230'),
                    QHXI: CodeQualite.of(Integer.of(1)),
                    FF2: PositiveFloat.of(3.3),
                    QFF2: CodeQualite.of(Integer.of(2)),
                    DD2: WindDirection.of(PositiveInteger.of(360)),
                    QDD2: CodeQualite.of(Integer.of(9)),
                    FXI2: PositiveFloat.of(3.3),
                    QFXI2: CodeQualite.of(Integer.of(0)),
                    DXI2: WindDirection.of(PositiveInteger.of(360)),
                    QDXI2: CodeQualite.of(Integer.of(1)),
                    HXI2: Time.of('1230'),
                    QHXI2: CodeQualite.of(Integer.of(2)),
                    FXI3S: PositiveFloat.of(3.3),
                    QFXI3S: CodeQualite.of(Integer.of(9)),
                    DXI3S: WindDirection.of(PositiveInteger.of(360)),
                    QDXI3S: CodeQualite.of(Integer.of(0)),
                    HFXI3S: Time.of('1230'),
                    QHFXI3S: CodeQualite.of(Integer.of(1)),
                    T: -5.5,
                    QT: CodeQualite.of(Integer.of(2)),
                    TD: -5.5,
                    QTD: CodeQualite.of(Integer.of(9)),
                    TN: -5.5,
                    QTN: CodeQualite.of(Integer.of(0)),
                    HTN: Time.of('1230'),
                    QHTN: CodeQualite.of(Integer.of(1)),
                    TX: -5.5,
                    QTX: CodeQualite.of(Integer.of(2)),
                    HTX: Time.of('1230'),
                    QHTX: CodeQualite.of(Integer.of(9)),
                    DG: PositiveInteger.of(4),
                    QDG: CodeQualite.of(Integer.of(0)),
                    T10: -5.5,
                    QT10: CodeQualite.of(Integer.of(1)),
                    T20: -5.5,
                    QT20: CodeQualite.of(Integer.of(2)),
                    T50: -5.5,
                    QT50: CodeQualite.of(Integer.of(9)),
                    T100: -5.5,
                    QT100: CodeQualite.of(Integer.of(0)),
                    TNSOL: -5.5,
                    QTNSOL: CodeQualite.of(Integer.of(1)),
                    TN50: -5.5,
                    QTN50: CodeQualite.of(Integer.of(2)),
                    TCHAUSSEE: -5.5,
                    QTCHAUSSEE: CodeQualite.of(Integer.of(9)),
                    DHUMEC: PositiveInteger.of(4),
                    QDHUMEC: CodeQualite.of(Integer.of(0)),
                    U: HumiditeRelative.of(100),
                    QU: CodeQualite.of(Integer.of(1)),
                    UN: HumiditeRelative.of(100),
                    QUN: CodeQualite.of(Integer.of(2)),
                    HUN: Time.of('1230'),
                    QHUN: CodeQualite.of(Integer.of(9)),
                    UX: HumiditeRelative.of(100),
                    QUX: CodeQualite.of(Integer.of(0)),
                    HUX: Time.of('1230'),
                    QHUX: CodeQualite.of(Integer.of(1)),
                    DHUMI40: PositiveInteger.of(4),
                    QDHUMI40: CodeQualite.of(Integer.of(2)),
                    DHUMI80: PositiveInteger.of(4),
                    QDHUMI80: CodeQualite.of(Integer.of(9)),
                    TSV: PositiveFloat.of(3.3),
                    QTSV: CodeQualite.of(Integer.of(0)),
                    PMER: PositiveFloat.of(3.3),
                    QPMER: CodeQualite.of(Integer.of(1)),
                    PSTAT: PositiveFloat.of(3.3),
                    QPSTAT: CodeQualite.of(Integer.of(2)),
                    PMERMIN: PositiveFloat.of(3.3),
                    QPMERMIN: CodeQualite.of(Integer.of(9)),
                    GEOP: PositiveInteger.of(4),
                    QGEOP: CodeQualite.of(Integer.of(0)),
                    N: Octa.of(PositiveInteger.of(8)),
                    QN: CodeQualite.of(Integer.of(1)),
                    NBAS: Octa.of(PositiveInteger.of(8)),
                    QNBAS: CodeQualite.of(Integer.of(2)),
                    CL: CodeSynop.of('/'),
                    QCL: CodeQualite.of(Integer.of(9)),
                    CM: CodeSynop.of('/'),
                    QCM: CodeQualite.of(Integer.of(0)),
                    CH: CodeSynop.of('/'),
                    QCH: CodeQualite.of(Integer.of(1)),
                    N1: Octa.of(PositiveInteger.of(8)),
                    QN1: CodeQualite.of(Integer.of(2)),
                    C1: CodeSynop.of('/'),
                    QC1: CodeQualite.of(Integer.of(9)),
                    B1: PositiveInteger.of(4),
                    QB1: CodeQualite.of(Integer.of(0)),
                    N2: Octa.of(PositiveInteger.of(8)),
                    QN2: CodeQualite.of(Integer.of(1)),
                    C2: CodeSynop.of('/'),
                    QC2: CodeQualite.of(Integer.of(2)),
                    B2: PositiveInteger.of(4),
                    QCB2: CodeQualite.of(Integer.of(9)),
                    N3: Octa.of(PositiveInteger.of(8)),
                    QN3: CodeQualite.of(Integer.of(0)),
                    C3: CodeSynop.of('/'),
                    QC3: CodeQualite.of(Integer.of(1)),
                    B3: PositiveInteger.of(4),
                    QB3: CodeQualite.of(Integer.of(2)),
                    N4: Octa.of(PositiveInteger.of(8)),
                    QN4: CodeQualite.of(Integer.of(9)),
                    C4: CodeSynop.of('/'),
                    QC4: CodeQualite.of(Integer.of(0)),
                    B4: PositiveInteger.of(4),
                    QB4: CodeQualite.of(Integer.of(1)),
                    VV: PositiveInteger.of(4),
                    QVV: CodeQualite.of(Integer.of(2)),
                    DVV200: PositiveInteger.of(4),
                    QDVV200: CodeQualite.of(Integer.of(9)),
                    WW: CodeTemps.of('99'),
                    QWW: CodeQualite.of(Integer.of(0)),
                    W1: CodeTemps.of('99'),
                    QW1: CodeQualite.of(Integer.of(1)),
                    W2: CodeTemps.of('99'),
                    QW2: CodeQualite.of(Integer.of(2)),
                    SOL: Etat.of(PositiveInteger.of(7)),
                    QSOL: CodeQualite.of(Integer.of(9)),
                    SOLNG: Etat.of(PositiveInteger.of(7)),
                    QSOLNG: CodeQualite.of(Integer.of(0)),
                    TMER: -5.5,
                    QTMER: CodeQualite.of(Integer.of(1)),
                    VVMER: Visibility.of(PositiveInteger.of(6)),
                    QVVMER: CodeQualite.of(Integer.of(2)),
                    ETATMER: Etat.of(PositiveInteger.of(7)),
                    QETATMER: CodeQualite.of(Integer.of(9)),
                    DIRHOULE: HouleDirection.of(PositiveInteger.of(999)),
                    QDIRHOULE: CodeQualite.of(Integer.of(0)),
                    HVAGUE: PositiveFloat.of(3.3),
                    QHVAGUE: CodeQualite.of(Integer.of(1)),
                    PVAGUE: PositiveFloat.of(3.3),
                    QPVAGUE: CodeQualite.of(Integer.of(2)),
                    HNEIGEF: PositiveInteger.of(4),
                    QHNEIGEF: CodeQualite.of(Integer.of(9)),
                    NEIGETOT: PositiveInteger.of(4),
                    QNEIGETOT: CodeQualite.of(Integer.of(0)),
                    TSNEIGE: PositiveFloat.of(3.3),
                    QTSNEIGE: CodeQualite.of(Integer.of(1)),
                    TUBENEIGE: PositiveInteger.of(4),
                    QTUBENEIGE: CodeQualite.of(Integer.of(2)),
                    HNEIGEFI3: PositiveInteger.of(4),
                    QHNEIGEFI3: CodeQualite.of(Integer.of(9)),
                    HNEIGEFI1: PositiveInteger.of(4),
                    QHNEIGEFI1: CodeQualite.of(Integer.of(0)),
                    ESNEIGE: Etat.of(PositiveInteger.of(7)),
                    QESNEIGE: CodeQualite.of(Integer.of(1)),
                    CHARGENEIGE: PositiveInteger.of(4),
                    QCHARGENEIGE: CodeQualite.of(Integer.of(2)),
                    GLO: PositiveInteger.of(4),
                    QGLO: CodeQualite.of(Integer.of(9)),
                    GLO2: PositiveInteger.of(4),
                    QGLO2: CodeQualite.of(Integer.of(0)),
                    DIR: PositiveInteger.of(4),
                    QDIR: CodeQualite.of(Integer.of(1)),
                    DIR2: PositiveInteger.of(4),
                    QDIR2: CodeQualite.of(Integer.of(2)),
                    DIF: PositiveInteger.of(4),
                    QDIF: CodeQualite.of(Integer.of(9)),
                    DIF2: PositiveInteger.of(4),
                    QDIF2: CodeQualite.of(Integer.of(0)),
                    UV: PositiveFloat.of(3.3),
                    QUV: CodeQualite.of(Integer.of(1)),
                    UV2: PositiveFloat.of(3.3),
                    QUV2: CodeQualite.of(Integer.of(2)),
                    UV_INDICE: UVIndex.of(PositiveInteger.of(12)),
                    QUV_INDICE: CodeQualite.of(Integer.of(9)),
                    INFRAR: PositiveInteger.of(4),
                    QINFRAR: CodeQualite.of(Integer.of(0)),
                    INFRAR2: PositiveInteger.of(4),
                    QINFRAR2: CodeQualite.of(Integer.of(1)),
                    INS: PositiveInteger.of(4),
                    QINS: CodeQualite.of(Integer.of(2)),
                    INS2: PositiveInteger.of(4),
                    QINS2: CodeQualite.of(Integer.of(9)),
                    TLAGON: -5.5,
                    QTLAGON: CodeQualite.of(Integer.of(0)),
                    TVEGETAUX: -5.5,
                    QTVEGETAUX: CodeQualite.of(Integer.of(1)),
                    ECOULEMENT: -5.5,
                    QECOULEMENT: CodeQualite.of(Integer.of(2)),
                },
            ]);
        });
    });
