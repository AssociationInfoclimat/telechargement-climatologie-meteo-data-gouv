    ...
    describe('parseCSV', () => {
        it('should parse the CSV', async () => {
            const csvLines = getAsyncGeneratorFromArray([
                ...
                '01014002;ARBENT;46.278167;5.669000;534;20230103;1.1;9;-2.2;9;1230;9;-2.2;9;1230;9;-2.2;9;-2.2;9;1.1;9;-2.2;9;-2.2;9;3;9;1.1;9;1.1;9;1.1;9;359;9;1230;9;1.1;9;359;9;1230;9;1.1;9;359;9;1230;9;1.1;9;359;9;1230;9;3;9',
            ...
            expect(infrahoraireLines).toEqual<QuotidienneLine[]>([
                {
                    ...
                    TNTXM: 14.7,
                    QTNTXM: CodeQualite.of(PositiveInteger.of(1)),
                    TAMPLI: PositiveFloat.of(6.1),
                    QTAMPLI: CodeQualite.of(PositiveInteger.of(1)),
                    TNSOL: null,
                    ...
                    QFF2M: CodeQualite.of(PositiveInteger.of(null)),
                    ...
                    QDXI: CodeQualite.of(PositiveInteger.of(9)),
                    HXI: Time.of('1943'),
                    ...
                    HXI3S: Time.of('1135'),
                    QHXI3S: CodeQualite.of(PositiveInteger.of(9)),
                    DRR: PositiveInteger.of(null),
                    QDRR: CodeQualite.of(PositiveInteger.of(null)),
                },
                {
                    NUM_POSTE: NumeroPoste.of('01014002'),
                    NOM_USUEL: 'ARBENT',
                ...
                },
                {
                    ...
                    TNTXM: -2.2,
                    QTNTXM: CodeQualite.of(PositiveInteger.of(9)),
                    TAMPLI: PositiveFloat.of(1.1),
                    QTAMPLI: CodeQualite.of(PositiveInteger.of(9)),
                    TNSOL: -2.2,
                    QTNSOL: CodeQualite.of(PositiveInteger.of(9)),
                    TN50: -2.2,
                    QTN50: CodeQualite.of(PositiveInteger.of(9)),
                    DG: PositiveInteger.of(3),
                    QDG: CodeQualite.of(PositiveInteger.of(9)),
                    FFM: PositiveFloat.of(1.1),
                    QFFM: CodeQualite.of(PositiveInteger.of(9)),
                    FF2M: PositiveFloat.of(1.1),
                    QFF2M: CodeQualite.of(PositiveInteger.of(9)),
                    FXY: PositiveFloat.of(1.1),
                    QFXY: CodeQualite.of(PositiveInteger.of(9)),
                    DXY: WindDirection.of(PositiveInteger.of(359)),
                    QDXY: CodeQualite.of(PositiveInteger.of(9)),
                    HXY: Time.of('1230'),
                    QHXY: CodeQualite.of(PositiveInteger.of(9)),
                    ...
                    QFXI2: CodeQualite.of(PositiveInteger.of(9)),
                    DXI2: WindDirection.of(PositiveInteger.of(359)),
                    QDXI2: CodeQualite.of(PositiveInteger.of(9)),
                    HXI2: Time.of('1230'),
                    QHXI2: CodeQualite.of(PositiveInteger.of(9)),
                    FXI3S: PositiveFloat.of(1.1),
                    QFXI3S: CodeQualite.of(PositiveInteger.of(9)),
                    DXI3S: WindDirection.of(PositiveInteger.of(359)),
                    QDXI3S: CodeQualite.of(PositiveInteger.of(9)),
                    HXI3S: Time.of('1230'),
                    QHXI3S: CodeQualite.of(PositiveInteger.of(9)),
                    DRR: PositiveInteger.of(3),
                    QDRR: CodeQualite.of(PositiveInteger.of(9)),
                },
                {
                    NUM_POSTE: NumeroPoste.of('01014002'),
                    NOM_USUEL: 'ARBENT',
                    ...
                    TNTXM: null,
                    QTNTXM: CodeQualite.of(PositiveInteger.of(null)),
                    TAMPLI: PositiveFloat.of(null),
                    QTAMPLI: CodeQualite.of(PositiveInteger.of(null)),
                    TNSOL: null,
                    QTNSOL: CodeQualite.of(PositiveInteger.of(null)),
                    TN50: null,
                    QTN50: CodeQualite.of(PositiveInteger.of(null)),
                    ...
                    QDXI3S: CodeQualite.of(PositiveInteger.of(null)),
                    HXI3S: Time.of(''),
                    QHXI3S: CodeQualite.of(PositiveInteger.of(null)),
                    DRR: PositiveInteger.of(null),
                    QDRR: CodeQualite.of(PositiveInteger.of(null)),
                },
            ]);
