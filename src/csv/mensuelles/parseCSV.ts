...
const mensuelleLineSchema = z.object({
    ...
    RR_ME: z.string().transform(parsePositiveFloat), // 1.1
    ...
    TX_ME: z.string().transform(parseFloatOrNull), // -2.2
    ...
    TN_ME: z.string().transform(parseFloatOrNull), // -2.2
    ...
    QETP: z.string().transform(parseCodeQualite), // 9
...
export async function* parseCSV(lines: AsyncGenerator<string>): AsyncGenerator<Result<MensuelleLine, ParseError>> {
